...
public class COMSerie_MainWindow {
	...
	public COMSerie_MainWindow() {	
		...
		JMenu mnSensor= new JMenu("Pr\u00E1ctica 7 - Sensor");
		mnSeleccionarPrctica.add(mnSensor);
		

		JRadioButtonMenuItem P7_Sensor= new JRadioButtonMenuItem("Sensor");
		P7_Sensor.addActionListener(Select_Practica);
		mnSensor.add(P7_Sensor);
