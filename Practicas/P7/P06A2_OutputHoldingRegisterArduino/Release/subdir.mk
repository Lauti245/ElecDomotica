...
CPP_SRCS += \
..\Gest_Modbus.cpp \
..\P06A2_OutputHoldingRegister.cpp \
..\config_practicas.cpp \
..\utils_domoBoard.cpp 

LINK_OBJ += \
.\Gest_Modbus.cpp.o \
.\P06A2_OutputHoldingRegister.cpp.o \
.\config_practicas.cpp.o \
.\utils_domoBoard.cpp.o 

CPP_DEPS += \
.\Gest_Modbus.cpp.d \
.\P06A2_OutputHoldingRegister.cpp.d \
...
P06A2_OutputHoldingRegister.cpp.o: ..\P06A2_OutputHoldingRegister.cpp
	@echo 'Building file: $<'
	@echo 'Starting C++ compile'
	"C:\Users\Lauti\Sloeber\arduinoPlugin\packages\arduino\tools\avr-gcc\7.3.0-atmel3.6.1-arduino7/bin/avr-g++" -c -g -Os -w -std=gnu++11 -fpermissive -fno-exceptions -ffunction-sections -fdata-sections -fno-threadsafe-statics -Wno-error=narrowing -MMD -flto -mmcu=atmega328p -DF_CPU=16000000L -DARDUINO=10812 -DARDUINO_AVR_UNO -DARDUINO_ARCH_AVR   -I"C:\Users\Lauti\Desktop\1uni\3\Domotica\P7\P06A2_OutputHoldingRegisterArduino" -I"C:\Users\Lauti\Desktop\1uni\3\Domotica\P7\P06A2_OutputHoldingRegisterArduino\DomoBoard" -I"C:\Users\Lauti\Desktop\1uni\3\Domotica\P7\P06A2_OutputHoldingRegisterArduino\ModbusSlave" -I"C:\Users\Lauti\Sloeber\arduinoPlugin\packages\arduino\hardware\avr\1.8.6\variants\standard" -I"C:\Users\Lauti\Sloeber\arduinoPlugin\packages\arduino\hardware\avr\1.8.6\cores\arduino" -MMD -MP -MF"$(@:%.o=%.d)" -MT"$@" -D__IN_ECLIPSE__=1 "$<" -o "$@"
	@echo 'Finished building: $<'
