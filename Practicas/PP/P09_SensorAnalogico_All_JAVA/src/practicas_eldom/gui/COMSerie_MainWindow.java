...
public class COMSerie_MainWindow {
	...
	public COMSerie_MainWindow() {	
		...
		JRadioButtonMenuItem P9_SensoresAnalgicosall = new JRadioButtonMenuItem("Sensores Analogicos");
		P9_SensoresAnalgicosall.addActionListener(Select_Practica);
		mnPrctica9.add(P9_SensoresAnalgicosall);
		
		
		JMenu mnPrctica10 = new JMenu("Práctica 10");
		mnSeleccionarPrctica.add(mnPrctica10); 
		
		JRadioButtonMenuItem P10_Pers = new JRadioButtonMenuItem("Persiana");
		P10_Pers.addActionListener(Select_Practica);
		mnPrctica10.add(P10_Pers);
		
		JRadioButtonMenuItem P10_Gara = new JRadioButtonMenuItem("Garaje");
		P10_Gara.addActionListener(Select_Practica);
		mnPrctica10.add(P10_Gara);
		...
		practicaSel.add(P10_Pers);
		practicaSel.add(P10_Gara);
