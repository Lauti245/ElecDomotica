...
/***        Type Definitions                                              ***/
/****************************************************************************/
//typedef void (*TNotifyModBusRegEvent)(unsigned int, unsigned int);
//typedef void (*TNotifyWriteCoilEvent)(unsigned int);
...
class ModbusSlave {
	...
	public:
		...
		//TNotifyModBusRegEvent	writesingleregister;
		//TNotifyWriteCoilEvent	writecoil;
		 ...
		 */
		void configure(unsigned char slave, long baud, char parity, byte txenpin);
		...
		void set_BankInputs(uint16_t *Regs, uint16_t lengthRegs);
