...
DomoBoard::DomoBoard()
{
	...
	pinMode(AMP1_P	 , INPUT);
	pinMode(AMP2_P	 , INPUT);
...
*/
	...
	AMP1.valor_Df 		= LOW;
	AMP1.Activo 		= true;
	AMP1.eSensor		= S_ANALOGICO;
	AMP1.name			= "Amplificador 1";
	AMP1.SensorEvent 	= NULL;

	AMP2.pin 			= AMP2_P;
	AMP2.valor 			= LOW;
	AMP2.valor_Df 		= LOW;
	AMP2.Activo 		= true;
	AMP2.eSensor		= S_ANALOGICO;
	AMP2.name			= "Amplificador 2";
	AMP2.SensorEvent 	= NULL;
...
void DomoBoard::clear_Actuators(){
	...
	PIR_MOV.SensorEvent = NULL;
	AMP1.SensorEvent = NULL;
	AMP1.managerActuators.clear();
	AMP2.SensorEvent = NULL;
	AMP2.managerActuators.clear();
}
