...
#define ADDR_TIEMPO_MINFOTOR_1	4
#define ADDR_TIEMPO_MINFOTOR_2	5
#define ADDR_TIEMPO_MAXFOTOR_1	6
#define ADDR_TIEMPO_MAXFOTOR_2	7
#define ADDR_TIEMPO_MAXFOTOT_1	8
#define ADDR_TIEMPO_MAXFOTOT_2	9
