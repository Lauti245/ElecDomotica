...
public class DomoBoardGui extends JPanel implements Visualizer {
	...
	public DomoBoardGui(String category, int address, CommTransport sn_Transport) {
		...
		panel_1_2.setBorder(new LineBorder(new Color(0, 0, 255), 2));
		panel_1_2.setBounds(10, 393, 404, 193);
		add(panel_1_2);
		
		JSlider slider = new JSlider();
		slider.setBounds(32, 28, 338, 45);
		panel_1_2.add(slider);
		
		JSlider slider_1 = new JSlider();
		slider_1.setBounds(32, 122, 338, 45);
		panel_1_2.add(slider_1);
		
		JLabel lblDimmer = new JLabel("DIMMER 1");
		lblDimmer.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblDimmer.setBounds(132, 10, 142, 24);
		panel_1_2.add(lblDimmer);
		
		JLabel lblDimmer_2 = new JLabel("DIMMER 2");
		lblDimmer_2.setFont(new Font("Times New Roman", Font.PLAIN, 20));
		lblDimmer_2.setBounds(132, 104, 142, 24);
		panel_1_2.add(lblDimmer_2);
/*		
