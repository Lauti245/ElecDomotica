...
public class COMSerie_MainWindow {
	...
	public COMSerie_MainWindow() {	
		...
		JMenu mnPrctica_11 = new JMenu("Práctica 11");
		mnSeleccionarPrctica.add(mnPrctica_11);
		
		JRadioButtonMenuItem P11_Dimmer = new JRadioButtonMenuItem("Dimmer");
		P11_Dimmer.addActionListener(Select_Practica);
		mnPrctica_11.add(P11_Dimmer);
